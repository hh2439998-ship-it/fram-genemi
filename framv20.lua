-- ==============================================================================
-- LIGHT GALAXY HUB - PERFECT KILL AURA V6 (FIX CHỐNG BỊ QUÁI ĐÁNH + SAFE FARM)
-- PURE LUAU UI - ANTI-DIE CORE - REAL BRING MOB UNDER PLAYER - MOBILE OPTIMIZED
-- ==============================================================================
...
Title.Text = "LIGHT GALAXY HUB ◆ PERFECT KILL AURA V6"
...
AddToggle(FarmPage, "Kill Aura/Fast Attack (Siêu Tốc Ngầm)", "FastAttack")
...
-- ==============================================================================
-- IV. ĐỘC QUYỀN: HỆ THỐNG FAST ATTACK LUỒNG MỚI & REAL BRING LY TÂM
-- ==============================================================================

-- 1. Xóa Hoạt Ảnh Chém Gốc
    ...
    if Hum then
        Hum.AnimationPlayed:Connect(function(Track)
            if _G.FastAttack then
                ...
                if string.find(animName, "attack") or string.find(animName, "slash") or string.find(animName, "punch") or string.find(animName, "combat") then
                    Track:Stop() 
                end
            end
        end)
...
-- 2. Core Fast Attack (ÉP KÍCH HOẠT MÔI TRƯỜNG DI ĐỘNG KHÔNG LOẠN MÀN HÌNH)
spawn(function()
    while table.freeze or task.wait() do
        if _G.FastAttack then
            -- Móc vũ khí liên tục
            pcall(function()
                local Char = LocalPlayer.Character
            ...
            -- Kích hoạt đòn đánh ngầm cực hạn (Không chạm màn hình)
            pcall(function()
        ...
        task.wait(0.001) -- Đẩy tốc độ vòng lặp lên mức tối đa
    end
end)

-- 3. Real Bring Mob (SAFE FARM: HÚT QUÁI XUỐNG DƯỚI CHÂN - CHỐNG BỊ ĐÁNH)
spawn(function()
                ...
                for _, Enemy in pairs(Workspace.Enemies:GetChildren()) do
                    if Enemy:FindFirstChild("HumanoidRootPart") and Enemy:FindFirstChild("Humanoid") and Enemy.Humanoid.Health > 0 then
                        if (Enemy.HumanoidRootPart.Position - MyRoot.Position).Magnitude < 350 and Count < 3 then
                            ...
                            -- CHÍ MẠNG: Đưa quái xuống thẳng dưới chân 8 studs
                            -- Quái bị kẹt góc không đánh được bạn, nhưng bạn chém xuống vẫn trúng tầm nhìn!
...
-- ==============================================================================
-- V. AUTO FARM & DI CHUYỂN TOÀN MAP
-- ==============================================================================
spawn(function()
