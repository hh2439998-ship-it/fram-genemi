-- ==============================================================================
-- LIGHT GALAXY HUB - PERFECT CORE V7 (FIX 100% LỖI KHÔNG LÊN UI - GIỮ NGUYÊN CODE)
...
Title.Text = "LIGHT GALAXY HUB ◆ PERFECT CORE V7"
...
-- ==============================================================================
-- II. ĐỊNH HÌNH TOÀN BỘ NÚT BẤM (GIỮ NGUYÊN ĐẦY ĐỦ KHÔNG MẤT NÚT)
-- ==============================================================================
...
-- ==============================================================================
-- IV. HỆ THỐNG FAST ATTACK THUẦN CODE & REAL BRING LY TÂM (ĐÃ FIX LỖI CRASH V6)
-- ==============================================================================
...
-- 2. Core Fast Attack (Đã đổi về cấu trúc vòng lặp chuẩn, chạy siêu mượt)
spawn(function()
    while true do
        task.wait(0.01) -- Giữ tiến trình ổn định, không gây nghẽn script
        if _G.FastAttack then
            -- Móc vũ khí liên tục
            pcall(function()
                local Char = LocalPlayer.Character
...
-- 3. Real Bring Mob (SAFE FARM: HÚT QUÁI XUỐNG THẲNG DƯỚI CHÂN 8 STUDS)
spawn(function()
    while true do
        task.wait(0.1)
        if _G.BringMob then
                ...
                for _, Enemy in pairs(Workspace.Enemies:GetChildren()) do
                    if Enemy:FindFirstChild("HumanoidRootPart") and Enemy:FindFirstChild("Humanoid") and Enemy.Humanoid.Health > 0 then
                        if (Enemy.HumanoidRootPart.Position - MyRoot.Position).Magnitude < 350 and Count < 3 then
                            ...
                            -- Đưa quái xuống thẳng dưới chân 8 studs để quái không đánh trúng ta
