...
-- LOGIC AUTO CLICK VIM INTEGRATED BY GEMINI
-- ==============================================================================
...
_G.FastAttack = false
_G.AutoClick = false -- Biến kích hoạt lõi Auto Click mới
_G.BringMob = false
...
AddToggle(FarmPage, "Auto Click VIM (Spam Màn Hình)", "AutoClick") -- Thêm nút bật tắt click màn hình mượt mà
...
-- ==============================================================================
-- IV. ĐỘC QUYỀN: HỆ THỐNG KILL AURA & REAL BRING & AUTO CLICK VIM
-- ==============================================================================
...
-- 2. Core Fast Attack (Đã bọc pcall an toàn để không treo UI)
spawn(function()
    while task.wait() do
        if _G.FastAttack then
            pcall(function()
                ...
                -- Đập lệnh tấn công liên tục
                if Controller and Controller.equipped then
                    Controller.timeToNextAttack = 0
                    Controller.hitboxMagnitude = 75
...
-- 4. Lõi Auto Click VIM (Spam chạm trực tiếp vào giữa màn hình thiết bị di động)
spawn(function()
    ...
    while task.wait() do
        if _G.AutoClick then
            pcall(function()
                ...
                -- Giả lập thao tác nhấp chuột/chạm tay siêu tốc
